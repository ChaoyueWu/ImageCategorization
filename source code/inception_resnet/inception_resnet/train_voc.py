...
dataset_dir = '/Users/jiechengwu/Desktop/tf_record'

# State where your log file is at. If it doesn't exist, create it.
log_dir = '../log'

# State where your checkpoint file is
checkpoint_file = '../pre_trained_models/inception_resnet_v2_2016_08_30.ckpt'
...
# ============== DATASET LOADING ======================
# We now create a function that creates a Dataset class which will give us
# many TFRecord files to feed in the examples into a queue in parallel.
def get_split(split_name, dataset_dir, file_pattern=file_pattern, file_pattern_for_counting='voc'):
    """
        ...
        with sv.managed_session() as sess:
            for step in range(num_steps_per_epoch * num_epochs):
                ...
                # If not, simply run the training step
                    ...
                    print('acc_val: {}'.format(accuracy_value))
